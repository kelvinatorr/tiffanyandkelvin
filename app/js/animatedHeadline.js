/* Custom jQuery script for Animated Headline by http://codyhouse.co/gem/css-animated-headlines/ */
	...
	function singleLetters($words) {
		$words.each(function(){
			...
			for (i in letters) {
				...
				if(word.parents('.scale').length > 0) letters[i] = ( letters[i] == ' ' ) ? '<em class="word-spacer">' + letters[i] + '</em>' : '<em>' + letters[i] + '</em>';
